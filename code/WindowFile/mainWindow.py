...
class mywindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.Border.setWindowTitle('GetBorder')
    ...
    def pushbutton_showimage(self): # 全屏显示图像
        ...
        try:
            ...
            error1 = QMessageBox.critical(self, "Input Error", "Select image to be shown.", QMessageBox.Yes | QMessageBox.No, QMessageBox.Yes)
            print(error1)
            return
        else:
            print('Image shows properly')
        dataset = gdal.Open(fileName)
        #print('测试数据矩阵: ',dataset)
